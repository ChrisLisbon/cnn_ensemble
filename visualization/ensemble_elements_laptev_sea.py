...
coastline = rotate(np.load('../matrices/laptev_land_mask.npy'))

mask = rotate(np.load('../matrices/laptev_land_mask.npy'))
...
img_folder = 'C:/Users/Julia/Pictures/ensemble_per_seas/laptev_sea'

for i in range(0, len(target_dates)):
    #np.save(f'../matrices/laptev_sea_ensemble_prediction/ens_{target_dates[i]}.npy', ensemble_forecast[i])
